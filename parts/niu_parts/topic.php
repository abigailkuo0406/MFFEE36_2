...
<div class="container">
	<div class="row">
		<div class="col-md-8">
			<div class="main-col">
				<div class="block">
					<h1 class="pull-left"><?= $singleTopic->title; ?></h1>
								...
								<div class="col-md-2">
									<div class="user-info">
										...
										<ul>
											...
											<li><a href="<?= APPURL; ?>/users/profile.php?name=<?= $singleTopic->user_name; ?>">Profile</a>
										</ul>
									</div>
								</div>
								<div class="col-md-10">
					...
					<form role="form" method="post" action="topic.php?id=<?= $id; ?>">
